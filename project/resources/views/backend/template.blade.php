...
<body>
        ...
        <div class="layout">
            <div class="header">
                <div class="logo logo-dark">
                    <a href="{{ route('home') }}">
                        <img width="150px" height="70px" src="/media/logo.png" alt="Logo">
                        <img width="70" height="30" class="logo-fold" src="/media/logo.png" alt="Logo">
                    </a>
                </div>
                ...
                <div class="side-nav-inner">
                    <ul class="side-nav-menu scrollable">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="{{ route('create_product') }}">Thêm sản phẩm</a>
                                </li>
                                <li>
                                    <a href="{{ route('productall') }}">Tất cả sản phẩm</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="{{ route('create_category') }}">Thêm danh mục</a>
                                    <a href="{{ route('categoryall') }}">Tất cả danh mục</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('create_option_view') }}">Thêm và Chi Tiết</a></li>
                                <li><a href="{{ route('option') }}">Tất cả Option</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle" href="javascript:void(0);">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="{{ route('order_view') }}">Tất cả đơn hàng</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scrollable">
                            ...
                            <div class="m-t-30">
                                ...
                                <div class="d-flex m-b-30">
                                    <div class="avatar avatar-image">
                                        <img src="/backend/assets/images/avatars/thumb-1.jpg" alt="">
                                    </div>
                                    <div class="m-l-15">
                                ...
                                <div class="d-flex m-b-30">
                                    <div class="avatar avatar-image">
                                        <img src="/backend/assets/images/avatars/thumb-2.jpg" alt="">
                                    </div>
                                    <div class="m-l-15">
                                ...
                                <div class="d-flex m-b-30">
                                    <div class="avatar avatar-image">
                                        <img src="/backend/assets/images/avatars/thumb-3.jpg" alt="">
                                    </div>
                                    <div class="m-l-15">
                            ...
                            <div class="m-t-30">
                                ...
                                <div class="d-flex m-b-30">
                                    <div class="avatar avatar-image">
                                        <img src="/backend/assets/images/others/img-1.jpg" alt="">
                                    </div>
                                    <div class="m-l-15">
    ...
    <script src="/backend/assets/vendors/chartjs/Chart.min.js"></script>
    <script src="/backend/assets/js/pages/dashboard-default.js"></script>
    <script src="/backend/assets/js/vendors.min.js"></script>
