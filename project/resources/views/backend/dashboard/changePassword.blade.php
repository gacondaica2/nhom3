                            ...
                            @include('backend.messages.messages')
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between m-b-30">
                                        <h2 class="m-b-0">Thay đổi mật khẩu</h2>
                                    </div>
                                    <form method="POST" action="{{ route('change_password') }}" autocomplete="off">
                                        @csrf
                                        <div class="form-group">
                                            <label class="font-weight-semibold" for="userName">Mật khẩu:</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-affix m-b-10">
                                                <i class="prefix-icon anticon anticon-lock"></i>
                                                <input type="password" name="repassword" class="form-control" id="password" placeholder="Nhập lại mật khẩu">
                                            </div>
                                        </div>
